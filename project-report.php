                  ...
                  if (mysqli_num_rows($users_res) > 0) {
                      ...
                      while($users_row=mysqli_fetch_array($users_res)) {
                          ...
                          <tr>
                              ...
                              <td><a href='view_user?id=<?php echo $users_id ?>'><?php echo $users_names; ?></a></td>
                              <td><a href='view_user?id=<?php echo $users_id ?>'><img src="<?php echo $users_image; ?>" class="responsive" width="100" height="100"/></a></td>
                              ...
                              <td width="15%"><div class="btn-group"><a href='edit-user?id=<?php echo $users_id ?>' data-toggle="tooltip" title="Edit" data-placement="top" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> </a>
                                      ...
                                      <a href='view_user?id=<?php echo $users_id ?>' class="btn btn-success btn-xs" data-toggle="tooltip" title="View Project" data-placement="top" ><i class="fa fa-eye"></i></a>
                                  </div>
                              </td>
                          </tr>
