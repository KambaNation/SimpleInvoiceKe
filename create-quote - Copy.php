    ...
    <div class="page-content">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    <?php
                    $mysqli = new mysqli("localhost","kanadsys_admin", "keny2015", "kanadsys_crm");
                    ...
                    <form role="form" method="post" action="" enctype="multipart/form-data" name="add_me" id="add_me">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="clients-name" class="form-control"  onchange="clientDetails(this.value)" required>
